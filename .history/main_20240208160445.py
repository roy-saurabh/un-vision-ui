...
st.markdown(
    ...
    with provided Python code snippets for further customization. This promotes in-depth data analysis and the ability to modify visualizations for specific needs. For more information and updates, visit the EduDataBot project page. 
