...
st.markdown(
    ...
    with provided Python code snippets for further customization. This promotes in-depth data analysis and the ability to modify visualizations for specific needs. For more information and updates, visit the Education Databot project page. 
    
    See the project README page [here](https://github.com/roy-saurabh/edudatabot/blob/main/README.md) for detailed steps.
