...
st.markdown(
    ...
    Education Databot utilizes OpenAI's GPT-3.5 Turbo and Azure OpenAI API to facilitate the creation of data visualizations and infographics, integrating with Python libraries like LlamaIndex, Lida, Trulens, and AffectLog. It supports a variety 
    of programming and visualization libraries, ensuring compatibility and ease of use. By employing the Retrieval-Augmented Generation (RAG) technique with UIS data, Education Databot provides accurate and relevant information. The tool further 
    refines goals through Trulens and AffectLog for trustworthiness, ensuring the generated visualizations are both meaningful and reliable. Users can set objectives, choose goals, and select visualization libraries for tailored plot creation, 
    with provided Python code snippets for further customization. This promotes in-depth data analysis and the ability to modify visualizations for specific needs. For more information and updates, visit the Education Databot project page. See the 
    project page [here](https://github.com/roy-saurabh/edudatabot/blob/main/README.md) for how-to steps in further details.
