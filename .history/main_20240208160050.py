...
st.markdown(
    ...
    EduDataBot utilizes OpenAI's GPT-3.5 Turbo and Azure OpenAI API to facilitate the creation of data visualizations and infographics, integrating with Python libraries like LlamaIndex, Lida, Trulens, and AffectLog. It supports a variety 
    of programming and visualization libraries, ensuring compatibility and ease of use. By employing the Retrieval-Augmented Generation (RAG) technique with UIS data, EduDataBot provides accurate and relevant information. The tool further 
    ...
    with provided Python code snippets for further customization. This promotes in-depth data analysis and the ability to modify visualizations for specific needs. For more information and updates, visit the EduDataBot project page. See the 
